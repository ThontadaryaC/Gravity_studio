  ...
  try {
    ...
    if (isRoleClaimed) {
      return {
        statusCode: 400,
        headers,
        body: JSON.stringify({ error: { message: "This administrative position is already claimed." } })
      };
    }
    ...
    if (isEmailClaimed) {
      return {
        statusCode: 400,
        headers,
        body: JSON.stringify({ error: { message: "This email is already associated with another administrative role." } })
      };
    }
